...
export default function WinkelmandProductEntry(props: {product : winkelmandProduct}){
    ...
    <Box className="WinkelmandProductEntry">
        <Grid className="winkelmandEntryGrid" alignItems="center">
            ...
            <GridItem><Box className="winkelmandProductNaam"><Text> Aantal: <Input display="inline-block" width="60px" height="30px" defaultValue={props.product.aantal} mb="2px"></Input></Text></Box></GridItem>
